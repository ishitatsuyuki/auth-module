...
export default class Auth {
  ...
  mounted () {
    ...
    return this.strategy.mounted(...arguments).catch(error => {
  ...
  fetchUser () {
    ...
    return this.strategy.fetchUser(...arguments).catch(error => {
  ...
  logout () {
    ...
    return this.strategy.logout(...arguments).catch(error => {
  ...
  reset () {
    ...
    return this.strategy.reset(...arguments).catch(error => {
